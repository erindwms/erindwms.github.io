 ...
 * Number, String,
 * Boolean, Array, Object or another data-type. Variables are powerful because 
 * they allow us to utilize the computer's memory.
 * Variables are called so because once created, we can CHANGE the value (and 
 * type of value) to which they point.
 *
...
// 4. hoisting
/* Variables are hoisted to the top of their function scope, or global scope, if
 ...
 * Lets are not hoisted to the top of the block of code in which they are 
 * declared.
 */
// Example:
let x = 1;
 ...
 * loops, or fucntions.
 * They are not hoisted to the top of the block of code in which they are 
 * declared.
 * Use const if the value of the variable isn't expected to change throughout an
 * application.
 * The const declaration created a read-only refrence to a value. Thus the 
 ...
 * the global scope.
 * Variables can only directly contain primitive values, such as numbers, 
 * strings, boolean, null & undefined types.
